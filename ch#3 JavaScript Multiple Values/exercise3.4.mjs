...
let carProperties= "color";
myCar[carProperties]="Gray";
// console.log(myCar.color);
carProperties="sunroof";
myCar[carProperties]="true";
// console.log(myCar.forSale);

let carMaker= myCar.make;
let carModel= myCar.model;
console.log(`This car is made by ${carMaker} & car model is ${carModel}`);

let carSale= myCar.forSale;
console.log(`This car is sell status is ${carSale}`);
